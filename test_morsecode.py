...
tmp = TestMorseCode()
tmp.test_is_validated_english_sentence()
tmp.test_get_cleaned_english_sentence()
tmp.test_encoding_character()
tmp.test_decoding_character()
tmp.test_decoding_sentence()
tmp.test_encoding_sentence()
tmp.test_main()
